  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      if (profileError) {
        ...
        setErrorMessage(profileError.message || "Failed to save profile.");
        return;
      }
      ...
      <section className="rounded-[36px] bg-[#F8FBFA] p-7 shadow-sm">
        ...
        <div className="mt-10 space-y-5">
          ...
          <button
            ...
            disabled={isLoading}
            className="flex w-full items-center justify-center gap-2 rounded-2xl bg-[#476973] py-4 font-semibold text-white transition hover:bg-[#3d5d66] disabled:cursor-not-allowed disabled:opacity-70"
          >
            {isLoading && (

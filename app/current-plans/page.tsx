        ...
        {loading ? (
          ...
          <div className="space-y-8">
            {plans.map((plan, index) => {
              ...
              const savings = Number(bestHospital?.savings ?? 0);

              return (
                <article
                  key={plan.id}
                  className="rounded-[32px] border border-white bg-[#F8FBFA] p-7 shadow-md"
                >
                  <div className="mb-7 rounded-3xl bg-[#365863] px-5 py-5 text-center">
                  ...
                  {bestHospital ? (
                      ...
                      <div className="p-5">
                        <div className="grid grid-cols-3 gap-3 text-center">
                          ...
                          <div className="rounded-2xl bg-white p-3">
                            ...
                            <p className="mt-1 font-bold">
                              {bestHospital.guarantee_days ?? 0} days
                            </p>
                    ...
                    <div className="mt-7 rounded-3xl bg-yellow-50 p-5 text-center text-yellow-800">
                      Hospital information is not available for this plan.
                    </div>
                  )}
                </article>
              );
